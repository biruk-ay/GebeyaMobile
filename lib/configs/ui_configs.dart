...
class ColorsConfigs {
  static const Color primary = Color.fromARGB(255, 22, 61, 250);
  static const Color primaryLight = Color.fromARGB(255, 245, 253, 254);
  static const Color primaryDark = Color.fromARGB(255, 20, 20, 20);
  static const Color secondary = Color.fromARGB(255, 236, 93, 255);
  static const Color tertiary = Color.fromARGB(255, 0, 88, 209);
  static const Color light = Color.fromARGB(255, 234, 234, 234);
